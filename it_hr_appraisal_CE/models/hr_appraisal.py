...
class HrAppraisal(models.Model):
    ...
    date_next_meeting = fields.Datetime('Date Next Meeting', readonly=1)
    ...
    def action_calendar_event(self):
        ...
        self.ensure_one()
        partner_ids = [manager.related_partner_id.id for manager in self.hr_manager_id if manager.related_partner_id]
        if self.emp_id.related_partner_id:
            partner_ids.append(self.emp_id.related_partner_id.id)
